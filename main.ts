	...
	async onload() {
		...
		const convertBibleTextToJWLibraryLink = (
			...
			try {
				...
				const bibleBooksPt = [
					["ge", "gen", "gén", "gênesis", "genesis", "génesis"],
					["ex", "êx", "êxo", "êxodo"],
					["le", "lev", "levítico"],
					["n", "num", "núm", "números"],
					["de", "deu", "deuteronómio"],
					...
					["1rs", "1reis"],
					["2rs", "2reis"],
					["1cr", "1cro", "1crô", "1cró", "1crónicas", "1cronicas"],
					["2cr", "2cro", "2crô", "2cró", "2crónicas", "2cronicas"],
					["esd", "esd", "esdras"],
					["ne", "nee", "neemias"],
					["est", "ester"],
					["jó"],
					["sal", "salmos"],
					["pr", "pro", "provérbios", "proverbios"],
					["ec", "ecl", "eclesiastes"],
					["cân", "cântico de salomão"],
					["is", "isa", "isaías", "isaias"],
					["je", "jer", "jeremias"],
					["la", "lam", "lamentações"],
					["ez", "eze", "ezequiel"],
					["da", "dan", "daniel"],
					...
					["at", "atos"],
					["ro", "rom", "romanos"],
					["1co", "1cor", "1coríntios", "1corintios"],
					["2co", "2cor", "2coríntios", "2corintios"],
					["gál", "gálatas", "galatas"],
					["ef", "efé", "efésios", "efesios"],
					["fil", "filipenses"],
					["col", "colossenses"],
					["1te", "1tes", "1tessalonicenses"],
					["2te", "2tes", "2tessalonicenses"],
					["1ti", "1tim", "1timóteo", "1timoteo"],
					["2ti", "2tim", "2timóteo", "2timoteo"],
					["tit", "tito"],
					["flm", "filêm", "filém", "filem", "filemon", "filémon"],
					["he", "heb", "hebreus"],
					["tg", "tia", "tiago"],
					["1pe", "1ped", "1pedro"],
					["2pe", "2ped", "2pedro"],
